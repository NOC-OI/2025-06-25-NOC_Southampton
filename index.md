...
humandate: "June 25-26, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2025-06-26        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
...
eventbrite: 1312006499759          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
...
<strong>Some adblockers block the registration window. If you do not see the
  registration box below, please go directly to the <a href="https://2025-06-25-intermediate-python.eventbrite.com">registration page.</a></strong>
...
<p id="about-this-workshop">
  ...
  This Software Carpentry course starts with some basic information about Python syntax, the Jupyter notebook interface, and move through how to import CSV files, using the Pandas package to work with data frames, how to calculate summary information from a data frame, and a brief introduction to plotting. It also demonstrates how to work with databases directly from Python.  Please see the course notes for further information or get in touch with us.
</p>
